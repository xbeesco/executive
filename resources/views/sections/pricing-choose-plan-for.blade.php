<section class="section-xl pricing-six-bg" style="background-image: url('{{ image($block['data']['background_image'] ?? '', 'section_background', 'pattern-bg-02.png') }}')">
	<div class="container">
		<div class="row g-0">
			<div class="col-md-12 col-xl-7 pbmit-pricing-style-1-new">
				<div class="pbminfotech-ele-ptable-style-1">
					<div class="pbmit-ptable-cols row">
						...
						<div class="pbmit-ptable-col col-md-6 {{ $plan['featured'] ?? false ? 'pbmit-pricing-table-featured-col' : '' }}">
								...
								<div class="pbmit-head-wrap">
									...
									<div class="pbmit-price-wrapper">
										<div class="pbmit-ptable-price-w">
											<div class="pbminfotech-ptable-symbol">{{ $block['data']['currency'] ?? 'EGP' }}</div>
			...
			<div class="col-md-12 col-xl-5">
				<div class="pricing-six-rightbox">
					<div class="pbmit-heading-subheading animation-style2">
						...
						<h2 class="pbmit-title">{{ $block['data']['title'] ?? 'Choose plan for your business' }}</h2>
					</div>
					<ul class="list-group list-group-borderless">
						@foreach($block['data']['benefits'] ?? [] as $benefit)
						<li class="list-group-item">
							<span class="pbmit-icon-list-icon">
								<i aria-hidden="true" class="pbmit-xinterio-icon {{ $benefit['icon'] ?? 'pbmit-xinterio-icon-check-mark' }}"></i>
							</span>
					...
					<div class="pbmit-btn-style-text">
						<a class="pbmit-btn" href="{{ $block['data']['button_link'] ?? '#' }}">
