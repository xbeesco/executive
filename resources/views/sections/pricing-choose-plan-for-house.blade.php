			<section class="section-xl pricing-one-bg" style="background-image: url('{{ image('https://xinterio-demo.pbminfotech.com/html-demo/images/homepage-1/bg/pricing-bg-shape.png', 'section_background') }}')">
				<div class="container">
					<div class="row g-0">
