						...
						<article class="pbmit-static-box-style-1">
							<div class="pbmit-staticbox-wrapper">
								<div class="pbmit-bg-imgbox" style="background-image: url(images/homepage-5/static-box/sbox-img-01.jpg)">
									<div class="pbmit-img">
										<img src="{{ image('https://xinterio-demo.pbminfotech.com/html-demo/images/homepage-5/static-box/sbox-img-01.jpg') }}" alt="">		
									</div>
						...
						<article class="pbmit-static-box-style-1">
							<div class="pbmit-staticbox-wrapper">
								<div class="pbmit-bg-imgbox" style="background-image: url(images/homepage-5/static-box/sbox-img-02.jpg)">
									<div class="pbmit-img">
										<img src="{{ image('https://xinterio-demo.pbminfotech.com/html-demo/images/homepage-5/static-box/sbox-img-02.jpg') }}" alt="">		
									</div>
						...
						<article class="pbmit-static-box-style-1">
							<div class="pbmit-staticbox-wrapper">
								<div class="pbmit-bg-imgbox" style="background-image: url(images/homepage-5/static-box/sbox-img-03.jpg)">
									<div class="pbmit-img">
										<img src="{{ image('https://xinterio-demo.pbminfotech.com/html-demo/images/homepage-5/static-box/sbox-img-03.jpg') }}" alt="">		
									</div>
						...
						<article class="pbmit-static-box-style-1">
							<div class="pbmit-staticbox-wrapper">
								<div class="pbmit-bg-imgbox" style="background-image: url(images/homepage-5/static-box/sbox-img-04.jpg)">
									<div class="pbmit-img">
										<img src="{{ image('https://xinterio-demo.pbminfotech.com/html-demo/images/homepage-5/static-box/sbox-img-04.jpg') }}" alt="">		
									</div>
