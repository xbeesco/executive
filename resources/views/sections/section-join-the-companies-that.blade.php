                        ...
                        <div class="pbmit-fld-contents">
                            <div class="pbmit-fld-wrap">
                                <h4 class="pbmit-fid-inner">
                                    ...
                                    <span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from="0" data-to="{{ $block['data']['counter_number'] ?? '500' }}" data-interval="5" data-before="" data-before-style="" data-after="" data-after-style="">{{ $block['data']['counter_number'] ?? '500' }}</span>
                                    <span class="pbmit-fid"><span>{{ $block['data']['counter_suffix'] ?? '+' }}</span></span>
                                </h4>
                                <span class="pbmit-fid-title">{{ $block['data']['counter_text'] ?? 'Happy Clients' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
